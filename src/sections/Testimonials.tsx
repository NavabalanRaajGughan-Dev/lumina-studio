  ...
  return (
    ...
    >
      ...
      <div ref={carouselRef} className="relative opacity-0">
        ...
        <div className="absolute top-0 left-0 w-24 h-full bg-linear-to-r from-white to-transparent z-10 pointer-events-none" />
        <div className="absolute top-0 right-0 w-24 h-full bg-linear-to-l from-white to-transparent z-10 pointer-events-none" />
      </div>

      {/* Decorative element */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-16">
        <div className="h-px bg-linear-to-r from-transparent via-softblack/10 to-transparent" />
      </div>
    </section>
  );
}
